...
public class JwtHelper {
	...
	public static DecodedJWT getDecoder(String token) throws JWTVerificationException {
	...
	public static String createHash(String subject, String issuer, Date expiresAt, Map<String, Object> header) {
		Builder builder = JWT.create();
